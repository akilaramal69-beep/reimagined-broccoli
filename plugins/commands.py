...
async def start_handler(client: Client, message: Message):
    ...
    app_url = Config.WEBAPP_URL if Config.WEBAPP_URL else "https://swift-vilhelmina-akila-10dce4a8.koyeb.app"
    if not app_url:
        return await message.reply_text("⚠️ Web App URL not configured.", quote=True)
